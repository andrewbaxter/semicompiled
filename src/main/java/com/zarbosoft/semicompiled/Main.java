            ...
            Stream.of(
                new TestGroup(
                    ...
                    Stream.of(
                        ...
                        javaNumericPrimitiveTestGroup(
                            "R8pc3gd1", double.class, Double.class, false),
                            ...
                            return javaPrimitiveTestGroup(
                                ...
                                Stream.of(
                                    new JavaTestBuilder("fFeCmGOv", "Downcast")
                                        .static1Args(
                                            Object.class,
                                            CodeBlock.of("$T y = ($T) x;", type, type))
                                        .build(),
                                    ...
                                    new JavaTestBuilder("WZsqJkGM", "Not equal")
                                        .static1Args(
                                            type, CodeBlock.of("boolean y = x != $S;", "lift"))
                                        .build()));
                          }
                        }.get(),
                        new Supplier<TestGroup>() {
                            ...
                            return new TestGroup(
                                ...
                                Stream.of(
                                    ...
                                    java0ArgsTest(
                                        ...
                                        "Element assignment",
                                        CodeBlock.of(
                                            "$T x = new $T[4];x[2] = 7;", type, int.class)),
                                    java0ArgsTest(
                                        "o5eUZxzz",
                                        "Element read",
                                        CodeBlock.of(
                        ...
                        new TestGroup(
                            ...
                            Stream.of(
                                java0ArgsTest(
                                    "tRjzSqTQ",
                                    "If",
                                    CodeBlock.of("int x = 3; if (true) { x = 4; }")),
                                java0ArgsTest(
                                    "VBUdfIx7",
                                    "If, else",
                                    CodeBlock.of(
                                        "int x = 3; if (x == 3) { x = 4; } else { x = 7; }")),
                                java0ArgsTest(
                                    "oqzuW0cR",
                        ...
                        new TestGroup(
                            ...
                            Stream.of(
                                java0ArgsTest(
                                    ...
                                    "Throw",
                                    CodeBlock.of(
                                        "throw new $T(\"Hello\");", RuntimeException.class)),
                                java0ArgsTest(
                                    "2ciu6bbD",
                                    "Try, finally",
                                    CodeBlock.of(
                                    ...
                                    .edit(
                                        c -> {
                                          c.class_(
                                              ...
                                              b -> {
                                                b.addField(
                                                    FieldSpec.builder(int.class, "x").build());
                ...
                new TestGroup(
                    ...
                    Stream.of(
                        ...
                        new JavaTestBuilder("c6kMuAp5", "First class function")
                            ...
                            .build()),
                    Stream.of())));
    generator.section(java, Stream.of());
